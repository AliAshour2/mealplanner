import PricingCard from '@/components/t'
...
const Subscribe = () => {
  return (
    <div className="py-16">
    <h2 className="mb-4 text-3xl font-bold text-center text-gray-900 dark:text-white">Choose your plan</h2>
    <p className="max-w-2xl mx-auto mb-12 text-center text-gray-600 dark:text-gray-300">
      Select the perfect meal planning subscription that fits your lifestyle and budget
    </p>
